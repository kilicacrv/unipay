...
const Register = () => {
  ...
  const handleAppleLogin = async () => {
    try {
      ...
      setError('Apple ile kayıt başarısız: ' + err.message);
    }
  };
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-slate-200/50 border border-white/80 p-6 md:p-8">
            ...
            <div className="flex flex-col gap-3">
              <button 
                ...
                className="w-full bg-white border-2 border-slate-100 text-slate-700 py-3.5 rounded-2xl text-sm font-bold flex items-center justify-center gap-3 hover:bg-slate-50 hover:border-slate-200 hover:shadow-md transition-all active:scale-[0.98]"
              >
              ...
              <button
                ...
                className="w-full bg-slate-900 border-2 border-slate-900 text-white py-3.5 rounded-2xl text-sm font-bold flex items-center justify-center gap-3 hover:bg-slate-800 hover:border-slate-800 hover:shadow-md transition-all active:scale-[0.98]"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M15.42 12.33c-.02-2.12 1.73-3.15 1.8-3.19-1-1.46-2.56-1.65-3.11-1.68-1.33-.14-2.59.78-3.26.78-.68 0-1.74-.75-2.85-.73-1.45.02-2.79.84-3.53 2.14-1.52 2.65-.39 6.57 1.1 8.73.72 1.05 1.58 2.22 2.73 2.18 1.1-.05 1.52-.72 2.87-.72 1.34 0 1.73.72 2.89.7 1.2-.02 1.95-1.07 2.66-2.11.83-1.21 1.17-2.39 1.19-2.45-.03-.02-2.31-.88-2.33-3.52zM14.61 5.92c.6-.73.99-1.74.88-2.75-1.04.04-2.17.69-2.79 1.44-.55.65-1.02 1.68-.89 2.67 1.16.09 2.2-.56 2.8-1.36z"/>
                </svg>
                Apple ile Hızlı Kayıt
              </button>
            </div>
